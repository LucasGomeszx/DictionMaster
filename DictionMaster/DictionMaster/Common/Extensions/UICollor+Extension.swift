...
extension UIColor {
    ...
    static let primaryCollor: UIColor = UIColor(red: 0.02, green: 0.18, blue: 0.22, alpha: 1.00)
    ...
    static let speakerDisable: UIColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 0.1)
